...
void menuSorting(Pesawat daftarPesawat[], int &jumlahPesawat) {
    ...
    while (!kembali) {
        ...
        if (pilihanSort == 1) {
            bubbleSortNamaAscending(daftarPesawat, jumlahPesawat);
        } else if (pilihanSort == 2) {
            selectionSortKapasitasDescending(daftarPesawat, &jumlahPesawat);
        } else if (pilihanSort == 3) {
            insertionSortTahunAscending(daftarPesawat, jumlahPesawat);
        ...
        if (pilihanSort != 0) {
            cout << "  Tekan Enter untuk kembali ke menu sorting..."; cin.get();
        }
    }
}
